...
use minecrust::{downloads::{download_assets, download_libraries, download_meta_for_version}, meta_parsing::{self, LauncherMeta, LauncherVersionManifestV2}};

#[tokio::main]
async fn main() {
    println!("Hi from minecrust binary!!!");
    let version: LauncherMeta = serde_json::from_str(download_meta_for_version("1.20.4")
        .await
